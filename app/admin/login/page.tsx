  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    if (match && password === 'admin123') {
      ...
      if (isValidHospital) {
        ...
        toast.success(`Logged in: ${hosp?.name}`);
        router.push('/admin/dashboard');
      } else {
        ...
        <Card className="w-full max-w-md">
          <CardHeader>
            <div className="space-y-2">
              ...
              <p className="text-sm text-gray-600">Update your hospital's live bed capacity</p>
            </div>
          </CardHeader>
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input type="email" placeholder="admin@h1.com" value={email} onChange={(e) => setEmail(e.target.value)} className="pl-10" disabled={isLoading} />
                </div>
              </div>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 space-y-2 text-sm">
                ...
                <div>
                  ...
                  <p className="text-blue-800">Email: <span className="font-mono">admin@h1.com</span> (h1–h15)</p>
